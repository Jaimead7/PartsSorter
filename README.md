...
- A [**CameraApp**](./cameraApp/README.md) that takes the photos and send them to the server.  
- A [**API**](./api/README.md) that manages the database, process input images and notify the clients.  
- A [**WebApp**](./webApp/README.md) to provide an interface for the final users.  
